          ...
          <ul className="flex flex-wrap -me-2">
            {variations[variationName].map((attribute: any) => (
              <li
                key={attribute.id}
                className={cn(
                  'cursor-pointer rounded border h-9 md:h-10 p-1 mb-2 md:mb-3 me-2 flex justify-center items-center font-extrabold text-sm md:text-15px text-skin-base transition duration-200 ease-in-out hover:text-skin-primary hover:border-skin-primary px-3',
                  {
