      ...
      <>
        <label htmlFor={searchId} className="flex flex-1 items-center py-0.5">
          <input
            ...
            onKeyDown={onKeyDown}
            className={cn(
              'text-heading outline-none w-full h-[52px] ps-5 md:ps-14 pe-14 md:pe-16 bg-skin-full text-skin-base text-sm lg:text-15px transition-all duration-200 focus:border-skin-primary focus:ring-1 focus:ring-skin-form',
              cls.round_input,
        ...
        {value ? (
          <button
            ...
            onClick={onClear}
            title="Clear search"
            className="outline-none absolute top-0 start-0 w-14 md:w-16 h-full flex items-center justify-center transition duration-200 ease-in-out hover:text-heading focus:outline-none"
          >
