  ...
  return (
    ...
    >
      <div className="flex items-center relative">
        ...
        <span className="cart-counter-badge flex items-center justify-center bg-skin-primary text-skin-inverted absolute -top-2.5 start-2.5 rounded-full font-extrabold">
          {totalItems}
        </span>
      </div>
      {!hideLabel && (
