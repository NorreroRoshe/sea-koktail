...
const AfterPassConf: React.FC<PassConfProps> = ({ isPopup = true, className }) => {
        ...
        <div className="w-full md:w-[50%] xl:w-[50%] py-6 sm:py-10 px-4 sm:px-8 xl:px-12 rounded-md shadow-dropDown flex flex-col justify-center">
          <div className="text-center mb-6 ">
            ...
            <div className="text-sm sm:text-15px text-body text-center mt-3 mb-1">
              {t('Вам на почту отправлены инструкции по смене пароля. Если в папке входящие не будет сообщений от нас , то пожалуйста проверьте папку спам!:)')}
              <br />
            </div>
