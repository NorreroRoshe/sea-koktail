...
import AddressSamovivoz from './addressSamovivoz';
...
const data = [
  ...
  },
  {
    ...
    component: <AddressSamovivoz />,
  },
];

const SamovivozDetails: React.FC = observer(() => {
...
export default SamovivozDetails;
