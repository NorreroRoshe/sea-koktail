          ...
          <div>
            ...
            <div>
              <span className={cls.about_desc}>
                Компания Morskoi Koktail - это профессиональный производитель люстр и светильников по
              ...
              <br />
              <br />
              Команда профессионалов Morskoi Koktail использует только высококачественные материалы и
