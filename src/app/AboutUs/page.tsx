            ...
            <div className={cls.container}>
              <div>
                ...
                <div className={`${cls.about_desc_wrapper} ${cls.about_desc_wrapper_reverse}`}>
                  ...
                  <div className={cls.desc_wrapper_text}>
                    ...
                    <span className={cls.about_desc}>
                      ...
                      <br />
                      <br /> 
                      ✔️ Шоковая заморозка непосредственно после вылова позволяет сохранить не только вкус и аромат, но и полезные свойства морепродуктов и рыбы. В результате на вашем столе натуральные продукты высшего качества.
                      <br />
                      <br />
                ...
                <div className={`${cls.about_desc_wrapper_sdq} ${cls.about_desc_wrapper}`}>
                  ...
                  />
                  <div className={cls.desc_wrapper_text}>
                    {/* <h3 className={cls.desc_wrapper_text_title}>Задача компании:</h3> */}
                    <span className={cls.about_desc}>
